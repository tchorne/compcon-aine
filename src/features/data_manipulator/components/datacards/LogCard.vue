<template>
    <div class="mission-content">
        <div class="top-row"> <h1 class="typewriter">  {{ log.title }}</h1></div>

        <v-divider v-if="log.date != ''"></v-divider>

        <header class="skewed-header" v-if="log.date != ''">
            <h2> {{ log.date }}</h2>
        ...
        <vue-markdown>{{ log.message }}</vue-markdown>
        <br>
        <blockquote v-if="log.attachments != ''"> {{ log.attachments}} </blockquote>
        <br>
